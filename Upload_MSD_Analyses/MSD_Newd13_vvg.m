...
num=xlsread('All_datasets_for_curate6.xlsx','New_13');%'AllData_Wk1');
...
ma.fitMeanMSDloglog(0.1)  % taking only 10% of the data points
ma.fitMeanMSDloglog(0.2)  % taking only 20% of the data points


%ma.plotMSD(gca, false); --- does not work
