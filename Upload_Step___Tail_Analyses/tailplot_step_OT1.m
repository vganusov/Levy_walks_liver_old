function h=tailplot_step_OT1(x, xmin, alpha)
% 
...
switch f_dattype,
    ...
    case 'REAL',
        ...
        h = loglog(c(:,1),c(:,2),'k>','MarkerSize',8,'MarkerFaceColor',[1 1 1]); hold on;
    ...
    case 'INTS', 
        ...
        %figure();
        h(1) = loglog(c(:,1),c(:,2),'k>','MarkerSize',8,'MarkerFaceColor',[1 1 1]); hold on;
